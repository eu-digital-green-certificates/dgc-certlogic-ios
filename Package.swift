...
let package = Package(
  ...
  platforms: [
    ...
    dependencies: [
        ...
        .package(name: "JsonLogic", url: "https://github.com/eu-digital-green-certificates/json-logic-swift.git", .branch("https://github.com/eu-digital-green-certificates/json-logic-swift.git")), //from: "1.2.2"),
